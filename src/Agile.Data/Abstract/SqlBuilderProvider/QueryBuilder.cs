...
namespace Agile.Data.Abstract
{
    public abstract class QueryBuilder : IDMLBuilder
    {
        public QueryBuilder()
        {
            this.Parameters = new List<AgileParameter>();
        }
        ...
        public virtual List<AgileParameter> Parameters { get; set; }
        ...
        public virtual string GetSelectValueByExpression()
        {
            ...
            {
                if (expression is LambdaExpression && (expression as LambdaExpression).Body is MethodCallExpression&&this.Context.CurrentConnectionConfig.DbType==DatabaseType.SqlServer&&this.OrderByValue.HasValue())
                {
        ...
        public virtual string GetSelectValueByString()
        {
            ...
            if (this.SelectValue.IsNullOrEmpty())
            {
                ...
                var columns = this.Context.EntityProvider.GetEntityInfo(this.EntityType).Columns.Where(it => !it.IsIgnore);
