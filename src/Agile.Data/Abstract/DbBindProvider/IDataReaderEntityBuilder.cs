...
namespace Agile.Data.Abstract
{
    ...
    public partial class IDataReaderEntityBuilder<T>
    {
        ...
        #region Fields
        private AgileProvider Context = null;
        ...
        private static readonly MethodInfo getEntity = typeof(IDataRecordExtensions).GetMethod("GetEntity", new Type[] { typeof(AgileProvider) });
        ...
        {
            DynamicMethod method = new DynamicMethod("AgileEntity", type,
            ...
            var columnInfos = this.Context.EntityProvider.GetEntityInfo(type).Columns;
        ...
        private void BindMethod(ILGenerator generator, EntityColumnInfo columnInfo, int ordinal)
        {
            ...
            #region Sqlite Logic
            if (this.Context.CurrentConnectionConfig.DbType == DatabaseType.Sqlite)
            {
