...
namespace Agile.Data.Abstract
{
    public class DbFirstTemplate
    {
        ...
        public static string PropertyTemplate = PropertySpace + "{AgileColumn}\r\n" +
        ...
        public const string KeyAgileTable = "{AgileTable}";
        public const string KeyConstructor = "{Constructor}";
        public const string KeyAgileColumn = "{AgileColumn}";
        ...
        public const string ValueAgileTable = "\r\n"+ClassSpace+ "[AgileTable(\"{0}\")]";
        public const string ValueAgileCoulmn = "\r\n"+PropertySpace+ "[AgileColumn({0})]";
        #endregion
