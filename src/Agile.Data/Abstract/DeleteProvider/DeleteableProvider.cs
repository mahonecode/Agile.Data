...
namespace Agile.Data.Abstract
{
    ...
    {
        public IAgileClient Context { get; set; }
        ...
        public IDeleteable<T> Where(string whereString, object parameters = null)
        {
            ...
            if (parameters != null)
            {
                ...
                {
                    DeleteBuilder.Parameters = new List<AgileParameter>();
                }
        ...
        public IDeleteable<T> Where(string whereString, AgileParameter parameter)
        {
            DeleteBuilder.Parameters.Add(parameter);
            return this;
        }
        public IDeleteable<T> Where(string whereString, AgileParameter[] parameters)
        {
            DeleteBuilder.Parameters.AddRange(parameters);
            return this;
        }
        public IDeleteable<T> Where(string whereString, List<AgileParameter> parameters)
        {
            DeleteBuilder.Parameters.AddRange(parameters);
            return this;
        }
        ...
        public IDeleteable<T> RemoveDataCache()
        {
            this.RemoveCacheFunc = () =>
            {
                ...
                CacheSchemeMain.RemoveCache(cacheService, this.Context.EntityProvider.GetTableName<T>());
            };
            return this;
        }
        ...
        {
            if (this.Context.CurrentConnectionConfig.DbType == DatabaseType.SqlServer)
                DeleteBuilder.TableWithString = lockString;
            return this;
        }

        public KeyValuePair<string, List<AgileParameter>> ToSql()
        {
            ...
            RestoreMapping();
            return new KeyValuePair<string, List<AgileParameter>>(sql, paramters);
        }
        ...
        private void _ExecuteCommand(out string sql, out AgileParameter[] paramters)
        {
            DeleteBuilder.EntityInfo = this.Context.EntityProvider.GetEntityInfo<T>();
        ...
        private void After(string sql)
        {
            if (this.IsEnableDiffLogEvent)
            {
                ...
                if (parameters == null)
                    parameters = new List<AgileParameter>();
        ...
        private List<DiffLogTableInfo> GetDiffTable(string sql, List<AgileParameter> parameters)
        {
