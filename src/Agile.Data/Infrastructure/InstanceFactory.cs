...
namespace Agile.Data.Infrastructure
{
    public class InstanceFactory
    {
        ...
        #region Queryable
        public static IAgileQueryable<T> GetQueryable<T>(ConnectionConfig currentConnectionConfig)
        {
            string className = "Queryable";
            className = GetClassName(currentConnectionConfig.DbType.ToString(), className);
            Interface.IAgileQueryable<T> result = CreateInstance<T, Interface.IAgileQueryable<T>>(className);
            return result;
        }
        public static IAgileQueryable<T, T2> GetQueryable<T, T2>(ConnectionConfig currentConnectionConfig)
        {
            string className = "Queryable";
            className = GetClassName(currentConnectionConfig.DbType.ToString(), className);
            IAgileQueryable<T, T2> result = CreateInstance<T, T2, IAgileQueryable<T, T2>>(className);
            return result;
        }
        public static IAgileQueryable<T, T2, T3> GetQueryable<T, T2, T3>(ConnectionConfig currentConnectionConfig)
        {
            string className = "Queryable";
            className = GetClassName(currentConnectionConfig.DbType.ToString(), className);
            IAgileQueryable<T, T2, T3> result = CreateInstance<T, T2, T3, IAgileQueryable<T, T2, T3>>(className);
            return result;
        }
        public static IAgileQueryable<T, T2, T3, T4> GetQueryable<T, T2, T3, T4>(ConnectionConfig currentConnectionConfig)
        {
            string className = "Queryable";
            className = GetClassName(currentConnectionConfig.DbType.ToString(), className);
            IAgileQueryable<T, T2, T3, T4> result = CreateInstance<T, T2, T3, T4, IAgileQueryable<T, T2, T3, T4>>(className);
            return result;
        }
        public static IAgileQueryable<T, T2, T3, T4, T5> GetQueryable<T, T2, T3, T4, T5>(ConnectionConfig currentConnectionConfig)
        {
            string className = "Queryable";
            className = GetClassName(currentConnectionConfig.DbType.ToString(), className);
            IAgileQueryable<T, T2, T3, T4, T5> result = CreateInstance<T, T2, T3, T4, T5, IAgileQueryable<T, T2, T3, T4, T5>>(className);
            return result;
        }
        public static IAgileQueryable<T, T2, T3, T4, T5, T6> GetQueryable<T, T2, T3, T4, T5, T6>(ConnectionConfig currentConnectionConfig)
        {
            string className = "Queryable";
            className = GetClassName(currentConnectionConfig.DbType.ToString(), className);
            IAgileQueryable<T, T2, T3, T4, T5, T6> result = CreateInstance<T, T2, T3, T4, T5, T6, IAgileQueryable<T, T2, T3, T4, T5, T6>>(className);
            return result;
        }
        public static IAgileQueryable<T, T2, T3, T4, T5, T6, T7> GetQueryable<T, T2, T3, T4, T5, T6, T7>(ConnectionConfig currentConnectionConfig)
        {
            string className = "Queryable";
            className = GetClassName(currentConnectionConfig.DbType.ToString(), className);
            IAgileQueryable<T, T2, T3, T4, T5, T6, T7> result = CreateInstance<T, T2, T3, T4, T5, T6, T7, IAgileQueryable<T, T2, T3, T4, T5, T6, T7>>(className);
            return result;
        }
        public static IAgileQueryable<T, T2, T3, T4, T5, T6, T7, T8> GetQueryable<T, T2, T3, T4, T5, T6, T7, T8>(ConnectionConfig currentConnectionConfig)
        {
            string className = "Queryable";
            className = GetClassName(currentConnectionConfig.DbType.ToString(), className);
            IAgileQueryable<T, T2, T3, T4, T5, T6, T7, T8> result = CreateInstance<T, T2, T3, T4, T5, T6, T7, T8, IAgileQueryable<T, T2, T3, T4, T5, T6, T7, T8>>(className);
            return result;
        }

        #region 9-12
        public static IAgileQueryable<T, T2, T3, T4, T5, T6, T7, T8, T9> GetQueryable<T, T2, T3, T4, T5, T6, T7, T8, T9>(ConnectionConfig currentConnectionConfig)
        {
            string className = "Queryable";
            className = GetClassName(currentConnectionConfig.DbType.ToString(), className);
            IAgileQueryable<T, T2, T3, T4, T5, T6, T7, T8, T9> result = CreateInstance<T, T2, T3, T4, T5, T6, T7, T8, T9, IAgileQueryable<T, T2, T3, T4, T5, T6, T7, T8, T9>>(className);
            return result;
        }
        public static IAgileQueryable<T, T2, T3, T4, T5, T6, T7, T8, T9, T10> GetQueryable<T, T2, T3, T4, T5, T6, T7, T8, T9, T10>(ConnectionConfig currentConnectionConfig)
        {
            string className = "Queryable";
            className = GetClassName(currentConnectionConfig.DbType.ToString(), className);
            IAgileQueryable<T, T2, T3, T4, T5, T6, T7, T8, T9, T10> result = CreateInstance<T, T2, T3, T4, T5, T6, T7, T8, T9, T10, IAgileQueryable<T, T2, T3, T4, T5, T6, T7, T8, T9, T10>>(className);
            return result;
        }
        public static IAgileQueryable<T, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> GetQueryable<T, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(ConnectionConfig currentConnectionConfig)
        {
            string className = "Queryable";
            className = GetClassName(currentConnectionConfig.DbType.ToString(), className);
            IAgileQueryable<T, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> result = CreateInstance<T, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, IAgileQueryable<T, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>>(className);
            return result;
        }
        public static IAgileQueryable<T, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> GetQueryable<T, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(ConnectionConfig currentConnectionConfig)
        {
            string className = "Queryable";
            className = GetClassName(currentConnectionConfig.DbType.ToString(), className);
            IAgileQueryable<T, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> result = CreateInstance<T, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, IAgileQueryable<T, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>>(className);
            return result;
        }
        #endregion
        ...
        {
            if (currentConnectionConfig.DbType == DatabaseType.Oracle)
            {
                return new OracleUpdateable<T>();
            }
            else if (currentConnectionConfig.DbType == DatabaseType.PostgreSQL)
            {
                return new PostgreSQLUpdateable<T>();
            }
            else if (currentConnectionConfig.DbType == DatabaseType.MySql)
            {
                return new MySqlUpdateable<T>();
            }
            else if (currentConnectionConfig.DbType == DatabaseType.Sqlite)
            {
                return new SqliteUpdateable<T>();
            }
            else if (currentConnectionConfig.DbType == DatabaseType.SqlServer)
            {
                return new SqlServerUpdateable<T>();
            }
            else
            {
        ...
        public static DeleteableProvider<T> GetDeleteableProvider<T>(ConnectionConfig currentConnectionConfig) where T : class, new()
        {
            ...
            {
                return new PostgreSQLDeleteable<T>();
            }
            else if (currentConnectionConfig.DbType == DatabaseType.MySql)
            {
                return new MySqlDeleteable<T>();
            }
            else if (currentConnectionConfig.DbType == DatabaseType.Sqlite)
            {
                return new SqliteDeleteable<T>();
            }
            else if (currentConnectionConfig.DbType == DatabaseType.SqlServer)
            {
                return new SqlServerDeleteable<T>();
            }
            else
            {
        ...
        public static InsertableProvider<T> GetInsertableProvider<T>(ConnectionConfig currentConnectionConfig) where T : class, new()
        {
            ...
            {
                return new PostgreSQLInsertable<T>();
            }
            else if (currentConnectionConfig.DbType == DatabaseType.MySql)
            {
                return new MySqlInsertable<T>();
            }
            else if (currentConnectionConfig.DbType == DatabaseType.Sqlite)
            {
                return new SqliteInsertable<T>();
            }
            else if (currentConnectionConfig.DbType == DatabaseType.SqlServer)
            {
                return new SqlServerInsertable<T>();
            }
            else
            {
        ...
        {
            return UtilConstants.AssemblyName + ".Realization." + type + name;
        }
