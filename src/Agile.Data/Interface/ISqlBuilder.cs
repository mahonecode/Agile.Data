...
namespace Agile.Data.Interface
{
    public partial interface ISqlBuilder
    {
        ...
        void RepairReplicationParameters(ref string appendSql, AgileParameter[] parameters, int addIndex);
        KeyValuePair<string, AgileParameter[]> ConditionalModelToSql(List<IConditionalModel> models, int beginIndex = 0);
    }
}
