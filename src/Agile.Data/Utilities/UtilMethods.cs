...
namespace Agile.Data.Utilities
{
    public class UtilMethods
    {
        ...
        public static string ReplaceSqlParameter(string itemSql, AgileParameter itemParameter, string newName)
        {
        ...
        internal static void RepairReplicationParameters(ref string appendSql, AgileParameter[] parameters, int addIndex,string append=null)
        {
