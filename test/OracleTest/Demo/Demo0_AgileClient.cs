...
{
    public class Demo0_AgileClient
    {

        public static void Init()
        {
            AgileClient();//Create db
            DbContext();//Optimizing AgileClient usage
        ...
        static AgileClient singleDb = new AgileClient(
        ...
        private static void DistributedTransactionExample()
        {
            ...
            {
                new ConnectionConfig(){ ConfigId="1", DbType=DatabaseType.SqlServer, ConnectionString=Config.ConnectionString,InitKeyType=InitKeyType.Attribute,IsAutoCloseConnection=true },
                new ConnectionConfig(){ ConfigId="2", DbType=DatabaseType.SqlServer, ConnectionString=Config.ConnectionString2 ,InitKeyType=InitKeyType.Attribute ,IsAutoCloseConnection=true}
            });
    ...
    public class DbContext
    {
        ...
        public AgileClient Db;
        public DbContext()
        {
            Db = new AgileClient(new ConnectionConfig()
            {
                ConnectionString = Config.ConnectionString,
                DbType = DatabaseType.SqlServer,
                IsAutoCloseConnection = true,
